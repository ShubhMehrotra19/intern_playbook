    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const res = await fetch('/api/auth/user/signup', {
                ...
                body: JSON.stringify({ name, email, password, phone, domain }),
            });
    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-background px-4 py-12 text-foreground sm:px-6 lg:px-8 relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
                <div className="absolute -top-1/2 -left-1/2 w-[1000px] h-[1000px] bg-indigo-900/30 rounded-full blur-3xl opacity-50 animate-pulse"></div>
                <div className="absolute top-1/2 right-0 w-[800px] h-[800px] bg-pink-900/20 rounded-full blur-3xl opacity-50"></div>
            </div>
            ...
            <div className="w-full max-w-md space-y-8 z-10 p-8 glass-panel rounded-2xl border border-border shadow-2xl bg-card/50 backdrop-blur-xl">
                <div className="text-center">
                    ...
                    <p className="mt-2 text-sm text-muted-foreground">
                        Join the Scaler Intern Program
                    </p>
                </div>
                ...
                <form className="mt-8 space-y-4" onSubmit={handleSubmit}>
                    <div className="rounded-md shadow-sm space-y-3">
                        ...
                        <div className="">
                            ...
                            >
                                <option value="None">Select Domain (Optional)</option>
                ...
                <div className="text-center mt-4">
                    <p className="text-sm text-muted-foreground">
                        ...
                        <Link href="/user/login" className="font-medium text-indigo-400 hover:text-indigo-300">
                            Sign in here
                        </Link>
                    </p>
                </div>
